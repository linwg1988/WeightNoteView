...
| ------------------------ | ---------------------------------:  |</br>
| title                    | 标题                                 |</br>
| bottom_label_content     | 底部标题                             |</br>
| top_corner_label         | 顶部角标                             |</br>
| top_corner_label         | 顶部角标                             |</br>
| bottom_corner_label      | 底部角标                             |</br>
| cell_padding             | 表格的内间距                          |</br>
| draw_bottom              | 是否绘制底部                          |</br>
| support_scale            | 是否支持缩放，默认不支持（现在效果不好） |</br>
| min_row_width            | 最小行（标题）表格宽度                 |</br>
| min_row_height           | 最小行表格高度                        |</br>
| min_column_width         | 最小行（内容）表格宽度                 |</br>
| fade_column_title_border | 列标题与内容之间的分割线是否颜色淡化处理 |</br>
